export default function FeatureCard({ image, alt, text }) {
  return (
    <div className="bg-graymatter-gray w-[23vw] h-[30vw] rounded-3xl flex flex-col justify-center items-center">
