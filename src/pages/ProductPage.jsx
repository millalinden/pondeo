      ...
      <section className="flex gap-12 p-16 w-full  bg-black">
        <div className="flex flex-col py-10 gap-8 w-1/2">
          ...
          <h2 className="text-4xl text-white font-bold">
            Unlock the Power of{" "}
            <span className="text-neon-green">Personalized Sales</span> Outreach{" "}
          </h2>
          <p className="text-gray-400">
            Elevate your sales strategy. Transform large-scale cold outreach
            into personal, engaging conversations. Pondeo combines technology
            with a human-centric approach to enhance lead connections
          </p>
          <div className="flex justify-flex-start">
            <Button label={"Free Trial"} color={"bg-black text-white"} />
          </div>
        </div>
        <div className="w-[549px] h-[676px] rounded-lg">
          <iframe className="w-full aspect-square " src={productHero}></iframe>
        </div>
      </section>
      ...
      <section className="flex justify-center items-center gap-12 mx-16 my-4 p-9 w-full  bg-black">
        <div className="flex flex-col py-10 gap-8 w-1/2 w-[1216px] h-[216px]">
          ...
          <p className="text-white">
            Pondeo personalises the cold outreach process, ensuring every
            communication feels unique and tailored to the recipient!{" "}
          </p>
          <div className="flex justify-flex-start">
            <Button label={"Book a Demo"} color={"bg-black text-white"} />
          </div>
        </div>
        <div className="bg-slate-300 w-[576px] h-[216px] rounded-md">
          <img src={Outreach} />
        </div>
      </section>
      ...
      <section className="flex justify-center items-center bg-deep-black px-16 py-4 gap-y-28 w-full">
        <div className="flex gap-4 p-4 h-72 ">
          <div className="flex flex-col justify-center items-center">
            <h3 className="custom-subtitle-1 text-neon-green">
              Efficiency and Workflow Streamlining
            </h3>
            <p className="custom-body-1 adventure-white">
        ...
        <div className="flex justify-center items-center gap-4 p-9">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="custom-subtitle-1 adventure-white">
              Open rates by up to 50% Achieve reply rates as high as 15%
            </p>
            <button></button>
          </div>
        </div>
      ...
      <section className="mt-10 flex justify-center items-center bg-deep-black">
        <div className=" w-full py-16 px-20">
          <div className="text-center">
            <h1 className="custom-heading-2-bold adventure-white p-2 mx-10 mb-4">
          ...
          <div className="flex justify-center items-center justify-around mb-10">
            <div className="max-w-64">
              ...
              <p className="text-xl text-left">
                Utilizes machine learning algorithms to analyze company
                information and learn about products, services, target audience,
            ...
            <div className="max-w-64">
              ...
              <p className="text-xl text-left">
                A smart assistant that effortlessly crafts messages customised
                for your potential clients. It's like having a knowledgeable
                friend guiding your communication efforts.
              </p>
            </div>
            ...
            <div className="max-w-64">
              ...
              <p className="text-xl text-left">
                Pondeo operates by analysing individual preferences, company
                details, and recent activities. By leveraging this information,
                Pondeo ensures that your messages resonate with the recipient's
                interests and needs. It's a smart chatbot that utilises
                variables such as channels, use cases, and even the tone of
                voice you prefer to craft personalised messages for effective
                communication
              </p>
            </div>
          </div>
      ...
      <section className="mt-10 flex justify-center items-center">
        <div className="bg-white w-full py-16 px-20">
          <div className="text-left">
            <h1 className="text-5xl p-2 mx-10 mb-4 text-neon-green">
              How it works
            </h1>
          </div>
          <hr className="border-slate-200 mb-7 mx-9" />
          <div className="flex justify-center items-center justify-around mb-10">
            <div className="max-w-64">
              ...
              <p className="text-xl text-left">
                ...
                company offers or the problems you solve. This information is
                input into the system, allowing Pondeo to understand the
                company's goals and offerings.
              </p>
              <div className="h-80 w-64 rounded-3xl mt-7 bg-black object-fit">
                <img src={HIW1} />
              </div>
